namespace EnhancementCalculator
{
    public static class WeaponBaseStats
    {
        ...
        public static (int patak, int matak) HeavensDivider = (342, 132);
        ...
        public static (int patak, int matak) ImperialStaff = (274, 193);
        ...
        public static (int patak, int matak) DragonHunterAxe = (342, 132);
        ...
        public static (int patak, int matak) AngelSlayer = (246, 132);
        ...
        public static (int patak, int matak) DemonSplinter = (342, 132);
        ...
        public static (int patak, int matak) DualTallumDarkLegion = (342, 132);
        ...
        public static (int patak, int matak) DraconicBow = (581, 132);
        ...
        public static (int patak, int matak) ForgottenBlade = (281, 132);
        ...
        public static (int patak, int matak) ArcanaMace = (225, 175);
        public static (int patak, int matak) Elysium = (232, 114);
        public static (int patak, int matak) BarakielsAxe = (251, 121);
        public static (int patak, int matak) BasaltBattleHammer = (281, 132);
        ...
        public static (int patak, int matak) SaintSpear = (281, 132);
    }
}
